...
#ifndef ORAN_NR_HELPER_H
#define ORAN_NR_HELPER_H
...
class OranHelper : public Object
{
  public:
     ...
     * This method not only instantiates an OranNrNearRtRic object, but it also
     ...
     */
    OranE2NodeTerminatorContainer DeployTerminators(Ptr<OranNrNearRtRic> nearRtRic,
                                                    NodeContainer nodes,
  ...
  private:
     ...
     */
    OranNrNearRtRic::LateCommandPolicy m_ricLmQueryLateCommandPolicy;
    /**
