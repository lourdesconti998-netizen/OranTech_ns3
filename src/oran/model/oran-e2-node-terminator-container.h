...
class OranE2NodeTerminatorContainer
{
  public:
     ...
     */
    typedef std::vector<Ptr<OranNrE2NodeTerminator>>::const_iterator Iterator;
    /**
     ...
     * @return The element.
     */
    Ptr<OranNrE2NodeTerminator> Get(uint32_t i) const;
    /**
     ...
     */
    void Add(Ptr<OranNrE2NodeTerminator> e2NodeTerminator);

  private:
    /**
     * The underlying container.
     */
    std::vector<Ptr<OranNrE2NodeTerminator>> m_e2NodeTerminators;
}; // class OranE2NodeTerminatorContainer
