...
#ifndef ORAN_REPORT_NR_UE_RSRP_RSRQ_H
#define ORAN_REPORT_NR_UE_RSRP_RSRQ_H
...
class OranReportNrUeRsrpRsrq : public OranReport
{
  public:
    /**
     * Get the TypeId of the OranReportNrUeRsrpRsrq class.
     *
     * @return The TypeId.
     */
    static TypeId GetTypeId();
    /**
     * Constructor of the OranReportNrUeRsrpRsrq class.
     */
    OranReportNrUeRsrpRsrq();
    /**
     * Destructor of the OranReportNrUeRsrpRsrq class.
     */
