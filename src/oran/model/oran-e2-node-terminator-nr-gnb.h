...
#include "oran-nr-near-rt-ric.h" //nuevo
 ...
 * Commands
 */
class OranE2NodeTerminatorNrGnb : public OranNrE2NodeTerminator
{
  public:
    /**
     * Get the TypeId of the OranE2NodeTerminatorNrGnb class.
     *
     * @return The TypeId.
     */
     ...
     * always returns the NR gNB type.
     *
     * @return the E2 Node Type.
     */
    OranNrNearRtRic::NodeType GetNodeType() const override;
    /**
     ...
     */
    Ptr<NetDevice> GetNrNetDevice() const override;


}; // class OranE2NodeTermiantorNrGnb
