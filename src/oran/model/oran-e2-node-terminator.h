 ...
 */
class OranNrE2NodeTerminator : public Object
{
  public:
    /**
     * Gets the TypeId of the OranNrE2NodeTerminator class.
     *
     * @returns The TypeId.
     */
    static TypeId GetTypeId();
    /**
     * Creates an instance of the OranNrE2NodeTerminator class.
     */
    OranNrE2NodeTerminator();
    /**
     * The destructor of the OranNrE2NodeTerminator class.
     */
    ~OranNrE2NodeTerminator() override;
    /**
     ...
     */
    virtual OranNrNearRtRic::NodeType GetNodeType() const = 0;
    /**
  ...
  public:
    ...
    virtual Ptr<NetDevice> GetNrNetDevice() const;
