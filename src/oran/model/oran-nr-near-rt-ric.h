...
#ifndef ORAN_NR_NEAR_RT_RIC_H
#define ORAN_NR_NEAR_RT_RIC_H
...
class OranNrNearRtRicE2Terminator;
 ...
 */
class OranNrNearRtRic : public Object
{
  public:
    /**
    ...
    enum NodeType
    {
        ...
        NRUE,   //NR UE identificador  IMSI (antes estaba para lte)
        NRGNB   //NR gNB identificador Cell ID
    ...
    /**
     * Get the TypeId of the OranNrNearRtRic class.
     *
     * @return The TypeId.
     */
    static TypeId GetTypeId();
    /**
     * Constructor of the OranNrNearRtRic class.
     */
    OranNrNearRtRic();
    /**
     * Destructor of the OranNrNearRtRic class.
     */
    ~OranNrNearRtRic() override;
    /**
     * Activate the RIC.
     *
     ...
     */
    Ptr<OranNrNearRtRicE2Terminator> GetE2Terminator() const;
    /**
     ...
     */
    OranNrNearRtRic::AddLmResult AddLogicModule(Ptr<OranLm> newLm);
    /**
     ...
     */
    OranNrNearRtRic::RemoveLmResult RemoveLogicModule(std::string name);
    /**
     ...
     */
    Ptr<OranNrDataRepository> Data() const;
    /**
  ...
  private:
     ...
     * The E2 Terminator.
     */
    Ptr<OranNrNearRtRicE2Terminator> m_e2Terminator;
    /**
     * The Data Repository implementation.
     */
    Ptr<OranNrDataRepository> m_data;
    /**
