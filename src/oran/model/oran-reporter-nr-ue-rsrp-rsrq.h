 ...
 * @ingroup oran
 *
 * A Reporter that captures the NR UE RSRP and RSRQ of the node.
 */
class OranReporterNrUeRsrpRsrq : public OranReporter
{
  public:
    /**
     * Get the TypeId of the OranReporterNrUeRsrpRsrq class.
     *
     * @return The TypeId.
     */
    static TypeId GetTypeId();
    /**
     * Constructor of the OranReporterNrUeRsrpRsrq class.
     */
    OranReporterNrUeRsrpRsrq();
    /**
     * Destructor of the OranReporterNrUeRsrpRsrq class.
     */
  ...
  protected:
    /**
     * Returns the genrated OranReportNrUeRsrpRsrq.
     *
