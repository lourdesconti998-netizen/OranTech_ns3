...
class OranReportTriggerNrUeHandover : public OranReportTrigger
{
  public:
    /**
     * Get the TypeId of the OranReportTriggerNrUeHandover class.
     *
     * @return The TypeId.
     */
    static TypeId GetTypeId();
    /**
     * Constructor of the OranReportTriggerNrUeHandover class.
     */
    OranReportTriggerNrUeHandover();
    /**
     * Destructor of the OranReportTriggerNrUeHandover class.
     */
  ...
  protected:
    ...
    /**
     * The callback for receiving the HandoverEndOk event from an NR UE.
    ...
    /**
     * The callback for receiving the ConnectionEstablished event from an NR UE.
     * @param imsi The IMSI of the UE.
     * @param cellId The ID of the new cell.
     * @param rnti The new RNTI of the UE.
     */
  ...
  private:
    /**
     * Disconnects the callback from the NR UE.
     */
    void DisconnectSink();
