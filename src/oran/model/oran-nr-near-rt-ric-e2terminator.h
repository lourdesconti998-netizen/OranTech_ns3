...
#ifndef ORAN_NR_NEAR_RT_RIC_E2TERMINATOR
#define ORAN_NR_NEAR_RT_RIC_E2TERMINATOR
 ...
 */
class OranNrNearRtRicE2Terminator : public Object
{
  public:
    /**
     * Get the TypeId of the OranNrNearRtRicE2 class.
     *
     * @return The TypeId.
     */
    static TypeId GetTypeId();
    /**
     * Constructor of the OranNrNearRtRicE2Terminator class.
     */
    OranNrNearRtRicE2Terminator();
    /**
     * Destructor of the OranNrNearRtRicE2Terminator class.
     */
    ~OranNrNearRtRicE2Terminator() override;
    /**
     ...
     */
    void ReceiveRegistrationRequest(OranNrNearRtRic::NodeType type,
                                    uint64_t id,
  ...
  private:
     ...
     */
    Ptr<OranNrNearRtRic> m_nearRtRic;
    /**
     ...
     */
    std::map<uint64_t, Ptr<OranNrE2NodeTerminator>> m_nodeTerminators;
    /**
...
#endif // ORAN_NR_NEAR_RT_RIC_E2TERMINATOR
