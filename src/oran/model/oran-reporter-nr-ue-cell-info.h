...
class OranReporterNrUeCellInfo : public OranReporter
{
  public:
    /**
     * Get the TypeId of the OranReporterNrUeCellInfo class.
     *
     * @return The TypeId.
     */
    static TypeId GetTypeId();
    /**
     * Constructor of the OranReporterNrUeCellInfo class.
     */
    OranReporterNrUeCellInfo();
    /**
     * Destructor of the OranReporterNrUeCellInfo class.
     */
    ~OranReporterNrUeCellInfo() override;

  protected:
    /**
     * Get the Cell ID of the attached NR cell, and generate an
