...
NrUeMac::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::NrUeMac")
            ...
            .AddTraceSource("ReportBufferStatus",                                                            // Se agrega el reporte TxBuffer
                            "Notifies ORAN about updates in the UE’s RLC buffer",
                            MakeTraceSourceAccessor(&NrUeMac::m_reportBufferStatus),
                            "ns3::Callback<void, ns3::NrMacSapProvider::BufferStatusReportParameters>");
    return tid;
}
