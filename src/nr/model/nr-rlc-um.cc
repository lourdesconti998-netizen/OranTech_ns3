...
NrRlcUm::NrRlcUm()
    : m_maxTxBufferSize(100000),// Tamaño máximo del buffer de transmisión RLC, en bytes
      m_txBufferSize(0), // Tamaño actual del buffer de transmisión RLC al inicializar la entidad
      m_sequenceNumber(0),
      m_vrUr(0),
      m_vrUx(0),
      m_vrUh(0),
